        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menusss dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                ...
                                $sql2xx = "SELECT * FROM notification WHERE rcv_email = '$u_email';";
          ...
          <li class="nav-item">
            ...
            <?php if($u_img=="FemaleImage"){?>
              ...
              <?php }?>
              <?php if($u_img=="MaleImage"){?>
                <img class="dropdown-toggle pro" src="img/man.png" alt="img" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
              <?php }?>
              <?php if($u_img!="MaleImage" && $u_img!="FemaleImage"){?>
              <img class="dropdown-toggle pro" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($u_img); ?>" alt="img" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
              <?php }?>

              <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href="profile.php"><i class="fa-solid fa-user"></i> My Profile</a></li>
                <li><a class="dropdown-item" onclick="cpass('<?php echo $u_email;?>', '<?php echo $pass;?>')"><i class="fa-solid fa-key"></i> Change Password</a></li>
