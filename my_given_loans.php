...
<body>
  ...
  <div class="mt">
  <h2 class="aaa"><i class="fa-solid fa-hand-holding-dollar"></i> My Given Loans</h2>
    <h4 class="aaaa">All of your given loans shown here</h4>
    <div class="overflow-auto">
      <table id="example" class="table table-borderless table-hover table-striped" style="width:100%">

        <thead class="table-dark ccc">
          <th>Loan Taker Image</th>
          <th>Loan Taker Name</th>
          <th>Loan Taker ID</th>
          <th>Loan Taker Email</th>
          <th>Amount</th>
          <th>Interest</th>
        ...
        <tbody>
          ...
          include '_dbconnect.php';
          $email = $_SESSION['email'];
          $q =  "SELECT * FROM `given_loan` where loan_giver='$email';";
          $run = mysqli_query($con, $q);
          $html = "";

          if (mysqli_num_rows($run) > 0) {
            while ($row = $run->fetch_assoc()) {
              $g_email = $row["loan_taker"];
              ...
              <tr><td>
                ...
                <a style="color: white;" href="payment2.php<?php echo "?pid="; echo $row["loan_id"]?>" class="btn btn-lg btn-block btn btn-info w-100"> ৳ Pay</a>
                <?php } ?>
                </td></tr>
                <?php }
          }
