...
<body>
  ...
  <div class="mt">
    <h2 class="aaa"><i class="fa-solid fa-piggy-bank"></i> My Loan Offers</h2>
    <h4 class="aaaa">All of your loan offers from others shown here</h4>
    <div class="overflow-auto">
      <table id="example" class="table table-borderless table-hover table-striped" style="width:100%">

        <thead class="table-dark ccc">
          <th>Offer Giver Image</th>
          <th>Offer Giver Name</th>
          <th>Offer Giver ID</th>
          <th>Offer Giver Email</th>
          <th>Amount</th>
          <th>Interest</th>
        ...
        <tbody>
          ...
          include '_dbconnect.php';
          $email = $_SESSION['email'];
          $q =  "SELECT * FROM `offerloan` where loan_taker='$email';";
          ...
          if (mysqli_num_rows($run) > 0) {
            while ($row = $run->fetch_assoc()) {
              ...
              <tr><td>
                ...
                <a onclick="f3(<?php echo $row["id"]  ?>)" class="btn btn-lg btn-block btn btn-success w-100"> <i class="fa-solid fa-check"></i> Accept</a>
                </td></tr>
                <?php }
          }
