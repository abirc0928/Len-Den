            ...
            <div style="margin-top:10%">
                <div class="col-lg-12 col-md-12 sm-12 lasttt2">
                    ...
                    <center>
                        ...
                        <h5 class="m-4" style="color:gray;">Enter Your Email</h5>

                        <form action="mail.php" method="POST">
                            <div class="form-group w-25">
                                <input type="email" class="form-control form-control email fn" name="email" aria-describedby="emailHelp" placeholder="Email" required>
                            </div>
