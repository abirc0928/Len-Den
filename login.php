    ...
    <form action="login2.php" method="POST">
      ...
      <div class="row">
        <div class="col-lg-7 col-md-5 left d-none d-md-block">
          <div class="row up">
            <h1 class="bold fs-lg-1 fs-md-4">UIU LOAN MANGEMENT<br>SYSTEM</h1>
            ...
            <button class="button-18" role="button">JOIN <i class="fa-solid fa-arrow-right"></i></button>
          </div>
          <div class="row down">
            <img class="log-img w-75 d-lg-none" src="img/2.png" alt="img">
            <img class="log-img w-50 d-lg-block d-none d-xl-none" src="img/2.png" alt="img">
            <img class="log-img d-none d-xl-block" src="img/2.png" alt="img" style="width:35%;">
          </div>
        </div>
