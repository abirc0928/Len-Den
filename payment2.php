...
$sql = "SELECT * FROM given_loan WHERE loan_id= '$pid'";
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <form action="update_payment.php" method="POST">
                                    <div class="form-group">
                                        <label for="username">
                                            <h2 style="margin-bottom: 5%;">Total Amount: ৳ <?php echo $amount?></h2>
                                            <h6>BKash Number</h6>
                                        </label>
                                        <input id="num" type="text" name="num" placeholder="Enter Your BKash Number" required class="form-control ">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button onclick="location.href = 'home.php';" type="button" class="w-100 subscribe btn btn-cus2 btn-block shadow-sm"> Cancel Payment & Return Home</button>
                        ...
                        <div id="paypal" class="tab-pane fade">
                            ...
                            <form action="update_payment.php" method="POST">
                                    ...
                                    <h2 style="margin-bottom: 5%;">Total Amount: ৳ <?php echo $amount?></h2>
                                        ...
                                        <input type="text" name="num" placeholder="Enter Your Nagad Number" required class="form-control ">
                                        <input type="hidden" name="pid" value=<?php echo $pid ?>>
                                        <input type="hidden" name="amount" value=<?php echo $amount ?>>
