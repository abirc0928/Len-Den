...
include '_dbconnect.php';
$email = $_SESSION['email'];
$q =  "SELECT * FROM `loan_req` where email='$email';";
...
if (mysqli_num_rows($run) > 0) {
  while ($row = $run->fetch_assoc()) {
    $html = $html . "<tr><td>"
      ...
      '<a class="btn btn-lg btn-block btn btn-danger w-100" onclick="f3('. $row["id"] .')"><i class="fa-solid fa-trash"> Delete</a>' .
      "</td></tr>";
  }
}
...
<head>
  ...
  <title>My Requested Loans</title>
...
<body>
  ...
  <div class="mt">
    ...
    <h2 class="aaa"><i class="fa-solid fa-file-contract"></i> My Requested Loans</h2>
    <h4 class="aaaa">All of your requested loans shown here</h4>
