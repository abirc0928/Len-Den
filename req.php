    ...
    <form action="req2.php" method="POST">
      <div class="row">
        <div class="col-lg-4 right22 d-none d-md-none d-lg-block">
          <img src="img/7.jpeg" alt="img" class="l2-img">
        </div>
        <div class="col-lg-8 col-md-12 col-sm-12 left22">

          <h3 class="h3x">Request Loan</h3>
          <?php if ($msg) { ?>
          ...
          <div class="form-group padx w-100">
            <input placeholder="Comfort Deadline" type="text" onfocus="(this.type = 'date')" id="date" class="form-control form-control-lg" name="deadline" required>
          </div>
          <div class="form-group padx">
            <input type="text" class="form-control form-control-lg" name="amount" placeholder="Amount" required>
          </div>
          <textarea id="w3review" rows="4" cols="50" class="form-control form-control-lg padx" name="reason" placeholder="Reasoning" required></textarea>

          <div class="form-radio padx">
            <input class="form-radio-input" name="intarest" type="radio" value="NO" id="flexCheckDefault">

            <label class="form-check-label" for="flexCheckDefault">
              I do not want to give interest
            </label>

          </div>
          <div class="form-radio padx">
            <input class="form-radio-input" name="intarest" type="radio" value="YES" id="flexCheckDefault2">

            <label class="form-check-label padx" for="flexCheckDefault2">
              I do want to give interest
            </label>

          </div>
          <div class="btn1">
            <button type="submit" class="btn btn-warning custom-btn w-100">Request</button>
          </div>
      ...
      <script>
        function f2() {
          Swal.fire(
            'Successfully Requested for Loan',
            '',
            'success'
          )
        }
